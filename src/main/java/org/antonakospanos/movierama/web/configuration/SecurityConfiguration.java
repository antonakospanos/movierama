...
import org.antonakospanos.movierama.web.security.authentication.MovieRamaAuthenticationProvider;
import org.antonakospanos.movierama.web.security.filters.AuthenticationFilter;
import org.antonakospanos.movierama.web.security.filters.ExceptionHandlerFilter;
import org.antonakospanos.movierama.web.security.filters.LoggingFilter;
...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
	...
	@Autowired
	MovieRamaAuthenticationProvider movieramaAuthenticationProvider;
	...
	public void configure(AuthenticationManagerBuilder auth) {
		 auth.authenticationProvider(movieramaAuthenticationProvider);
	}
